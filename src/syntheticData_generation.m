function BVP = syntheticData_generation(BVP)
    %% Assign from BVP
    ...
    mean_Y_exp_x_Surf = makeSurf(sensor_connectivity, mean_Y_exp{1});
    mean_Y_exp_y_Surf = makeSurf(sensor_connectivity, mean_Y_exp{2});
