function BVP = statFEM_update_LE(BVP)
      %% Assign from BVP
    % Degrees of freedom
    ...
    mu_ux = BVP.lsNIPCE.LE.mean_ux;
    mu_uy = BVP.lsNIPCE.LE.mean_uy;
    C_ux = BVP.lsNIPCE.LE.cov_ux;
    C_uy = BVP.lsNIPCE.LE.cov_uy;
    ...
    C_ex = BVP.obs.C_e{1};
    C_ey = BVP.obs.C_e{2};
    C_dx = BVP.hyp.LE.C_d{1}; % Covariance for X dimension
    C_dy = BVP.hyp.LE.C_d{2}; % Covariance for Y dimension
    ...
    % mu_ux_y = 0.35 * mu_ux_y0;
    % mu_uy_y = 0.35 * mu_uy_y0;
    ...
    BVP.statFEM.LE.mu_u_y = mu_u_y;
    BVP.statFEM.LE.mu_ux_y = mu_ux_y;
    BVP.statFEM.LE.mu_uy_y = mu_uy_y;
    BVP.statFEM.LE.mu_ux_y_Surf = mu_ux_y_Surf;
    BVP.statFEM.LE.mu_uy_y_Surf = mu_uy_y_Surf;
    BVP.statFEM.LE.cov_u_y = C_u_y;
    BVP.statFEM.LE.cov_ux_y = C_ux_y;
    BVP.statFEM.LE.cov_uy_y = C_uy_y;
    BVP.statFEM.LE.std_ux_y = std_ux_y;
    BVP.statFEM.LE.std_uy_y = std_uy_y;
    BVP.statFEM.LE.std_ux_y_Surf = std_ux_y_Surf;
    BVP.statFEM.LE.std_uy_y_Surf = std_uy_y_Surf;

    BVP.statFEM.LE.mu_zx = mu_zx;
    BVP.statFEM.LE.mu_zy = mu_zy;
    BVP.statFEM.LE.cov_zx = cov_zx;
    BVP.statFEM.LE.cov_zy = cov_zy;
    BVP.statFEM.LE.std_zx = std_zx;
    BVP.statFEM.LE.std_zy = std_zy;
end
